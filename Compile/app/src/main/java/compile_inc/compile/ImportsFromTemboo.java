...
public class ImportsFromTemboo {
    public void getTwitter() throws TembooException {
...
// Set inputs
        ...
        // Get an InputSet for the choreo
        Tweets.TweetsInputSet tweetsInput = tweetsChoreo.newInputSet();
        // set inputs
        tweetsInput.set_AccessToken("1409214422-nt6kEhomT5ywIWO5213gmpAYn3bkuDQOgWi5cWl");
        tweetsInput.set_AccessTokenSecret("kpPbqZ5b2885ZOnd8yeABk9biyQvAyLn9XWXvxZxLnyg8");
        tweetsInput.set_ConsumerKey(twitterKey);
        tweetsInput.set_ConsumerSecret(twitterSecret);
        tweetsInput.set_Query("Philly");

        // execute Choreo
        Tweets.TweetsResultSet statusesShowResults = tweetsChoreo.execute(tweetsInput);
...
//Twitter
    ...
    //Facebook
//initialize OAuth
    public void getFacebook() throws TembooException {
        InitializeOAuth initializeOAuthChoreo = new InitializeOAuth(session);
